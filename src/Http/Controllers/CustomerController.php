...
class CustomerController extends Controller
{
    ...
    public function index() {
        ...
        $items = DevPos::customer()->cache()->get();
        ...
        return view('devpos::customers', [

            'title' => __('Customers'),
            'breadcrumb' => [

                __('Customers') => route('devpos.customers.index')
            ],
            'menu' => 'devpos.customers',
            'items' => $items,
            'idTypes' => $idTypes,
            'countries' => $countries,
        ]);
    ...
    public function store(Request $request) {
        ...
        try {
            ...
            $item = DevPos::customer()->create($request->all());
        }
    ...
    public function update(Request $request, $id) {
        ...
        try {
            ...
            $item = DevPos::customer()->update($id, $request->all());
        }
        catch(\Illuminate\Http\Client\RequestException $error) {
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            $item = DevPos::customer()->destroy($id);
        }
        catch(\Illuminate\Http\Client\RequestException $error) {
        ...
        return response()->json([
            ...
            'DevPos' => $item,
            'Data' => $deleted,
            'Msg' => $deleted == 0 ? 'Customer deleted successfully':'Customer didn\'t deleted successfully!'
        ]);
    }
