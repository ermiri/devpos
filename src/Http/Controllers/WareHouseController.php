...
class WareHouseController extends Controller
{
    ...
    public function index() {
        ...
        $items = DevPos::warehouse()->cache()->get();

        //get supplierList from devpos
        $warehouseTypes = DevPos::enum()->getWareHouseType();

        
        return view('devpos::warehouses', [

            'title' => __('Supplier Lists'),
            'breadcrumb' => [

                __('Supplier Lists') => route('devpos.warehouses.index')
            ],
            'menu' => 'devpos.warehouses',
            'items' => $items,
    ...
    public function update(Request $request, $id) {
        ...
        try {
            ...
            $item = DevPos::warehouse()->update($id, $request->all());
        }
        catch(\Illuminate\Http\Client\RequestException $error) {
    ...
    public function destroy($id)
    {
        ...
        return response()->json([
            ...
            'DevPos' => $item,
            'Data' => $deleted,
            'Msg' => $deleted == 0 ? 'WareHouse deleted successfully':'WareHouse didn\'t deleted successfully!'
        ]);
    }
