...
class RoleController extends Controller
{
    ...
    public function index() {
        ...
        $items = DevPos::role()->cache()->get();
        
        return view('devpos::roles', [

            'title' => __('Roles'),
            'breadcrumb' => [

                __('Roles') => route('devpos.roles.index')
            ],
            'menu' => 'devpos.roles',
            'items' => $items,
        ]);
    ...
    public function store(Request $request) {
        ...
        try {
            ...
            $item = DevPos::role()->create($request->all());
        }
    ...
    public function update(Request $request, $id) {
        ...
        try {
            ...
            $item = DevPos::role()->update($id, $request->all());
        }
        catch(\Illuminate\Http\Client\RequestException $error) {
    ...
    public function destroy($id)
    {
        ...
        return response()->json([
            ...
            'DevPos' => $item,
            'Data' => $deleted,
            'Msg' => $deleted == 0 ? 'Role deleted successfully':'Role didn\'t deleted successfully!'
        ]);
    }
