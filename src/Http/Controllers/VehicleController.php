...
class VehicleController extends Controller
{
    ...
    public function index() {
        ...
        $items = DevPos::vehicle()->get();
        
        return view('devpos::vehicles', [

            'title' => __('Vehicles'),
            'breadcrumb' => [

                __('Vehicles') => route('devpos.vehicles.index')
            ],
            'menu' => 'devpos.vehicles',
            'items' => $items,
        ]);
    }
    ...
    public function store(Request $request) {
        ...
        try {
            ...
            $item = DevPos::vehicle()->create($request->all());
        }
    ...
    public function update(Request $request, $id) {
        ...
        try {
            ...
            $item = DevPos::vehicle()->update($id, $request->all());
        }
        catch(\Illuminate\Http\Client\RequestException $error) {
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            $item = DevPos::vehicle()->destroy($id);
        }
        catch(\Illuminate\Http\Client\RequestException $error) {
        ...
        return response()->json([
            ...
            'DevPos' => $item,
            'Data' => $deleted,
            'Msg' => $deleted == 0 ? 'Vehicle deleted successfully':'Vehicle didn\'t deleted successfully!'
        ]);
    }
