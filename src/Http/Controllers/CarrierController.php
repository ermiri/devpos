...
class CarrierController extends Controller
{
    ...
    public function index() {
        ...
        $items = DevPos::carrier()->get();

        // //get supplierList from devpos
        // $warehouseTypes = DevPos::enum()->getCarrierType();

        // //get idTypes from devpos
        $idTypes = DevPos::enum()->getIdTypes();

        
        return view('devpos::carriers', [

            'title' => __('Carriers'),
            'breadcrumb' => [

                __('Carriers') => route('devpos.carriers.index')
            ],
            'menu' => 'devpos.carriers',
            'items' => $items,
            'idTypes' => $idTypes,
        ]);
    }
    ...
    public function store(Request $request) {
        ...
        try {
            ...
            $item = DevPos::carrier()->create($request->all());
        }
    ...
    public function update(Request $request, $id) {
        ...
        try {
            ...
            $item = DevPos::carrier()->update($id, $request->all());
        }
        catch(\Illuminate\Http\Client\RequestException $error) {
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            $item = DevPos::carrier()->destroy($id);
        }
        catch(\Illuminate\Http\Client\RequestException $error) {
        ...
        return response()->json([
            ...
            'DevPos' => $item,
            'Data' => $deleted,
            'Msg' => $deleted == 0 ? 'Carrier deleted successfully':'Carrier didn\'t deleted successfully!'
        ]);
    }
