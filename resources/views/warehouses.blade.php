...
@section('subheader-buttons')
    ...
    <div class="k-subheader__toolbar">
        <div class="k-subheader__wrapper">
            ...
            <a href="javascript:void(0);" class="btn btn-label btn-label-brand btn-bold" title="Edit" data-placement="top" onClick="DevPos.WareHouse.create();">
                <i class="fa fa-plus"></i> <span class="d-none d-md-inline"> {{ __('WareHouse') }}</span>
            </a>
...
@section('js-local')
    ...
    <script>
        ...
        Cache.put('warehouses', @php echo json_encode($items) @endphp);
        Cache.put('warehouseTypes', @php echo json_encode($warehouseTypes) @endphp);

        $(document).ready(function(){

            DevPos.WareHouse.load();
