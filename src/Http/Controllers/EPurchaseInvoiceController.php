...
class EPurchaseInvoiceController extends Controller
{
    /**
    ...
    public function index() {
        ...
        if (request()->ajax()) {
            ...
            $items = DevPos::epurchaseinvoice()->get();
            return [
        ...
        return view('devpos::epurchase-invoices', [

            'title' => __('EPurchaseInvoices'),
            'breadcrumb' => [

                __('EPurchaseInvoices') => route('devpos.epurchase-invoices.index')
            ],
            'menu' => 'devpos.epurchase-invoices',
            //'items' => $items,
            'tcrs' => $tcrs,
    ...
    public function create() {
        ...
        //get cities from devpos
        $einvoiceProcesses = DevPos::enum()->getEPurchaseInvoiceProcesses();

        //get cities from devpos
        $envoiceDocumentTypes = DevPos::enum()->getEPurchaseInvoiceDocumentTypes();
        ...
        return view('devpos::einvoice-new', [
            ...
            'breadcrumb' => [
                ...
                __('EPurchaseInvoices') => route('devpos.epurchase-invoices.index'),
               'New EPurchaseInvoice' => route('devpos.epurchase-invoices.create')
            ],
            'menu' => 'devpos.epurchase-invoices',
            //'items' => $items,
            'tcrs' => $tcrs,
