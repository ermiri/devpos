...
class ProductGroupController extends Controller
{
    ...
    public function index() {
        ...
        $items = DevPos::productGroup()->cache()->get();
        
        return view('devpos::product-groups', [

            'title' => __('Product Groups'),
            'breadcrumb' => [

                __('Product Groups') => route('devpos.product-groups.index')
            ],
            'menu' => 'devpos.product-groups',
            'items' => $items,
        ]);
    }
    ...
    public function store(Request $request) {
        ...
        try {
            ...
            $item = DevPos::productGroup()->create($request->all());
        }
    ...
    public function update(Request $request, $id) {
        ...
        try {
            ...
            $item = DevPos::productGroup()->update($id, $request->all());
        }
        catch(\Illuminate\Http\Client\RequestException $error) {
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            $item = DevPos::productGroup()->destroy($id);
        }
        catch(\Illuminate\Http\Client\RequestException $error) {
        ...
        return response()->json([
            ...
            'DevPos' => $item,
            'Data' => $deleted,
            'Msg' => $deleted == 0 ? 'ProductGroup deleted successfully':'ProductGroup didn\'t deleted successfully!'
        ]);
    }
