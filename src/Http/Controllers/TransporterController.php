...
class TransporterController extends Controller
{
    ...
    public function index() {
        ...
        $items = DevPos::transporter()->cache()->get();
        
        return view('devpos::transporters', [

            'title' => __('Supplier Lists'),
            'breadcrumb' => [

                __('Supplier Lists') => route('devpos.transporters.index')
            ],
            'menu' => 'devpos.transporters',
            'items' => $items,
        ]);
    }
    ...
    public function store(Request $request) {
        ...
        try {
            ...
            $item = DevPos::transporter()->create($request->all());
        }
    ...
    public function update(Request $request, $id) {
        ...
        try {
            ...
            $item = DevPos::transporter()->update($id, $request->all());
        }
        catch(\Illuminate\Http\Client\RequestException $error) {
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            $item = DevPos::transporter()->destroy($id);
        }
        catch(\Illuminate\Http\Client\RequestException $error) {
        ...
        return response()->json([
            ...
            'DevPos' => $item,
            'Data' => $deleted,
            'Msg' => $deleted == 0 ? 'Transporter deleted successfully':'Transporter didn\'t deleted successfully!'
        ]);
    }
