...
@section('subheader-buttons')
    ...
    <div class="k-subheader__toolbar">
        <div class="k-subheader__wrapper">
            ...
            <a href="javascript:void(0);" class="btn btn-label btn-label-brand btn-bold" title="Edit" data-placement="top" onClick="DevPos.User.create();">
                <i class="fa fa-plus"></i> <span class="d-none d-md-inline"> {{ __('User') }}</span>
            </a>
                    ...
                    <div class="k-portlet k-portlet--mobile" id="quickSearchPortlet">
                        ...
                        <div class="k-portlet__body">
                            <div class="row" id="filterForm" data-filter-itemType="tcrs">
                                ...
                                <form name="filter" class="col-12" onsubmit="event.preventDefault();DevPos.ProductGroup.load();">
...
@section('js-local')
    ...
    <script>
        ...
        Cache.put('users', @php echo json_encode($items) @endphp);
        Cache.put('cities', @php echo json_encode($cities) @endphp);
        Cache.put('pos', @php echo json_encode($pos) @endphp);
        Cache.put('supplierList', @php echo json_encode($supplierList) @endphp);
        Cache.put('roles', @php echo json_encode($roles) @endphp);
