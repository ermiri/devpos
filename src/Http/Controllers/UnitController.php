...
class UnitController extends Controller
{
    ...
    public function index() {
        ...
        $items = DevPos::unit()->cache()->get();

        // //get supplierList from devpos
        $standardCodes = DevPos::enum()->getUnits();

        
        return view('devpos::units', [

            'title' => __('Units'),
            'breadcrumb' => [

                __('Units') => route('devpos.units.index')
            ],
            'menu' => 'devpos.units',
            'items' => $items,
    ...
    public function store(Request $request) {
        ...
        try {
            ...
            $item = DevPos::unit()->create($request->all());
        }
    ...
    public function update(Request $request, $id) {
        ...
        try {
            ...
            $item = DevPos::unit()->update($id, $request->all());
        }
        catch(\Illuminate\Http\Client\RequestException $error) {
    ...
    public function destroy($id)
    {
        ...
        return response()->json([
            ...
            'DevPos' => $item,
            'Data' => $deleted,
            'Msg' => $deleted == 0 ? 'Unit deleted successfully':'Unit didn\'t deleted successfully!'
        ]);
    }
