                    ...
                    <div class="k-portlet k-portlet--mobile" id="quickSearchPortlet">
                        ...
                        <div class="k-portlet__body">
                            <div class="row" id="filterForm" data-filter-itemType="invoices">
                                ...
                                <form name="main_filter" class="col-12" onsubmit="event.preventDefault();DevPos.EInvoice.load();">

                                    <div class="form-group row mb-0">
                                        
                                        <div class="col-md-4 col-xl-2">
                                            <label class="">{{ __('EInvoice Type') }}</label>
                                            <select name="isPurchase" class="form-control">
                                               <option value="true">{{ __('Purchased') }}</option>
                                               <option value="false" selected>{{ __('Sales') }}</option>
                                            </select>
                                        </div>
                    ...
                    <div class="k-portlet k-portlet--mobile" id="quickSearchPortlet">
                        ...
                        <div class="k-portlet__body">
                            <div class="row" id="filterForm" data-filter-itemType="tcrs">
                                ...
                                <form name="filter" class="col-12" onsubmit="event.preventDefault();DevPos.EInvoice.load();">
