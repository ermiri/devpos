...
class UserController extends Controller
{
    ...
    public function index() {
        ...
        //get supplierList
        $supplierList = DevPos::supplierList()->get();

        //get roles
        $roles = DevPos::role()->get();
        
        return view('devpos::users', [

            'title' => __('Users'),
            'breadcrumb' => [

                __('Users') => route('devpos.users.index')
            ],
            'menu' => 'devpos.users',
            'items' => $items,
            'cities' => $cities,
    ...
    public function store(Request $request) {
        ...
        try {
            ...
            $item = DevPos::user()->create($request->all());
        }
    ...
    public function update(Request $request, $id) {
        ...
        try {
            ...
            $item = DevPos::user()->update($id, $request->all());
        }
        catch(\Illuminate\Http\Client\RequestException $error) {
    ...
    public function destroy($id)
    {
        ...
        return response()->json([
            ...
            'DevPos' => $item,
            'Data' => $deleted,
            'Msg' => $deleted == 0 ? 'User deleted successfully':'User didn\'t deleted successfully!'
        ]);
    }
