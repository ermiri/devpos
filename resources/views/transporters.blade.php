...
@section('subheader-buttons')
    ...
    <div class="k-subheader__toolbar">
        <div class="k-subheader__wrapper">
            ...
            <a href="javascript:void(0);" class="btn btn-label btn-label-brand btn-bold" title="Edit" data-placement="top" onClick="DevPos.Transporter.create();">
                <i class="fa fa-plus"></i> <span class="d-none d-md-inline"> {{ __('Transporter') }}</span>
            </a>
...
@section('js-local')
    ...
    <script>
        ...
        Cache.put('transporters', @php echo json_encode($items) @endphp);

        $(document).ready(function(){

            DevPos.Transporter.load();
