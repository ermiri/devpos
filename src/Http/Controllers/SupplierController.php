...
class SupplierController extends Controller
{
    ...
    public function index() {
        ...
        $items = DevPos::supplier()->cache()->get();
        
        return view('devpos::suppliers', [

            'title' => __('Suppliers'),
            'breadcrumb' => [

                __('Suppliers') => route('devpos.suppliers.index')
            ],
            'menu' => 'devpos.suppliers',
            'items' => $items
        ]);
    }
    ...
    public function store(Request $request) {
        ...
        try {
            ...
            $item = DevPos::supplier()->create($request->all());
        }
    ...
    public function show($id)
    {
        ...
        return view($view, [
            ...
            'breadcrumb' => [
                ...
                __('Supplier') => route('suppliers.index')
            ],
            'menu' => 'supplier',
    ...
    public function update(Request $request, $id) {
        ...
        try {
            ...
            $item = DevPos::supplier()->update($id, $request->all());
        }
        catch(\Illuminate\Http\Client\RequestException $error) {
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            $item = DevPos::supplier()->destroy($id);
        }
        catch(\Illuminate\Http\Client\RequestException $error) {
        ...
        return response()->json([
            ...
            'DevPos' => $item,
            'Data' => $deleted,
            'Msg' => $deleted == 0 ? 'Supplier deleted successfully':'Supplier didn\'t deleted successfully!'
        ]);
    }
