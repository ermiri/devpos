...
@section('subheader-buttons')
    ...
    <div class="k-subheader__toolbar">
        <div class="k-subheader__wrapper">
            ...
            <a href="javascript:void(0);" class="btn btn-label btn-label-brand btn-bold" title="Edit" data-placement="top" onClick="DevPos.SupplierList.create();">
                <i class="fa fa-plus"></i> <span class="d-none d-md-inline"> {{ __('Supplier List') }}</span>
            </a>
