...
/**
 * Branch - is the class that will contain all methods for tcr
...
class Branch extends Model {
    ...
    public function get() {
        ...
        return $this->httpGet('/api/v3/Branch');
    }
    ...
    public function create($parameters = []) {
        ...
        return $this->post('/api/v3/Branch', $parameters);
    }

    public function find($id) {

        return $this->httpGet('/api/v3/Branch/'. $id);
    }
    ...
    public function update($id, $parameters = []) {
        ...
        return $this->put('/api/v3/Branch/'. $id, $parameters);
    }

    //delete pos on devpos
    public function destroy($id) {

        return $this->delete('/api/v3/Branch/'. $id);
    }
